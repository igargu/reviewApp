        ...
        <div class="section-title" data-aos="zoom-out">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
            ...
            <form action="{{ url('review') }}" method="post" enctype="multipart/form-data">
              ...
              <input class="form-control" type="text" name="iduser" id="iduser" value="{{ Auth::user()->id }}" hidden>
              <input class="form-control" type="text" name="idimage" id="idimage" value="1" hidden>
              ...
              <div class="row">
                <div class="form-group mt-3">
                  <textarea class="form-control" name="review" id= "review" rows="5" placeholder="Review" required>{{ old('review') }}</textarea>
                  @error('review')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="text-center">
                <a href=" {{ url('home') }} "><input class="button-custome-modal" type="button" value="Cancel" /></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" class="button-custome-modal">Publish</button>
              </div>
            </form>
